...
class PerfDogServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.setEnableNewFps = channel.unary_unary(
                '/com.perfdog.proto.PerfDogService/setEnableNewFps',
                request_serializer=perfdog__pb2.SetEnableNewFpsReq.SerializeToString,
                response_deserializer=perfdog__pb2.Empty.FromString,
                )
        self.startCpuSampling = channel.unary_unary(
                '/com.perfdog.proto.PerfDogService/startCpuSampling',
                request_serializer=perfdog__pb2.StartCpuSamplingReq.SerializeToString,
                response_deserializer=perfdog__pb2.StartCpuSamplingRsp.FromString,
                )
        self.stopCpuSamplingAndFetch = channel.unary_stream(
                '/com.perfdog.proto.PerfDogService/stopCpuSamplingAndFetch',
                request_serializer=perfdog__pb2.StopCpuSamplingReq.SerializeToString,
                response_deserializer=perfdog__pb2.CpuSampleRecord.FromString,
                )
        self.updateConfiguration = channel.unary_unary(
                '/com.perfdog.proto.PerfDogService/updateConfiguration',
...
class PerfDogServiceServicer(object):
    ...
    def setEnableNewFps(self, request, context):
        """仅用于windows，设置是否启用新的FPS计算方式
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def startCpuSampling(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def stopCpuSamplingAndFetch(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_PerfDogServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'setEnableNewFps': grpc.unary_unary_rpc_method_handler(
                    servicer.setEnableNewFps,
                    request_deserializer=perfdog__pb2.SetEnableNewFpsReq.FromString,
                    response_serializer=perfdog__pb2.Empty.SerializeToString,
            ),
            'startCpuSampling': grpc.unary_unary_rpc_method_handler(
                    servicer.startCpuSampling,
                    request_deserializer=perfdog__pb2.StartCpuSamplingReq.FromString,
                    response_serializer=perfdog__pb2.StartCpuSamplingRsp.SerializeToString,
            ),
            'stopCpuSamplingAndFetch': grpc.unary_stream_rpc_method_handler(
                    servicer.stopCpuSamplingAndFetch,
                    request_deserializer=perfdog__pb2.StopCpuSamplingReq.FromString,
                    response_serializer=perfdog__pb2.CpuSampleRecord.SerializeToString,
            ),
...
class PerfDogService(object):
    ...
    def setEnableNewFps(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.perfdog.proto.PerfDogService/setEnableNewFps',
            perfdog__pb2.SetEnableNewFpsReq.SerializeToString,
            perfdog__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def startCpuSampling(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.perfdog.proto.PerfDogService/startCpuSampling',
            perfdog__pb2.StartCpuSamplingReq.SerializeToString,
            perfdog__pb2.StartCpuSamplingRsp.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def stopCpuSamplingAndFetch(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/com.perfdog.proto.PerfDogService/stopCpuSamplingAndFetch',
            perfdog__pb2.StopCpuSamplingReq.SerializeToString,
            perfdog__pb2.CpuSampleRecord.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
